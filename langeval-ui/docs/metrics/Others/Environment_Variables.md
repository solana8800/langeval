...
Boolean flags[​](#boolean-flags "Direct link to Boolean flags")
---------------------------------------------------------------
...
Display / Truncation[​](#display--truncation "Direct link to Display / Truncation")
-----------------------------------------------------------------------------------
...
Retry / Backoff Tuning[​](#retry--backoff-tuning "Direct link to Retry / Backoff Tuning")
-----------------------------------------------------------------------------------------
...
Timeouts / Concurrency[​](#timeouts--concurrency "Direct link to Timeouts / Concurrency")
-----------------------------------------------------------------------------------------
...
Telemetry / Debug[​](#telemetry--debug "Direct link to Telemetry / Debug")
--------------------------------------------------------------------------
...
Model Settings[​](#model-settings "Direct link to Model Settings")
------------------------------------------------------------------
...
### Variable Options[​](#variable-options "Direct link to Variable Options")
...
[Edit this page](https://github.com/confident-ai/deepeval/edit/main/docs/docs/environment-variables.mdx)

Last updated on **Jan 12, 2026** by **Trevor**