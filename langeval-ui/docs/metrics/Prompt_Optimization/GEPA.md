...
Optimize Prompts With GEPA[​](#optimize-prompts-with-gepa "Direct link to Optimize Prompts With GEPA")
------------------------------------------------------------------------------------------------------
...
Customize GEPA[​](#customize-gepa "Direct link to Customize GEPA")
------------------------------------------------------------------
...
How Does GEPA Work?[​](#how-does-gepa-work "Direct link to How Does GEPA Work?")
--------------------------------------------------------------------------------
...
### Step 1: Golden Splitting[​](#step-1-golden-splitting "Direct link to Step 1: Golden Splitting")
...
### Step 2: Pareto Selection[​](#step-2-pareto-selection "Direct link to Step 2: Pareto Selection")
...
#### Finding Non-Dominated Prompts[​](#finding-non-dominated-prompts "Direct link to Finding Non-Dominated Prompts")
...
#### Sampling from the Frontier[​](#sampling-from-the-frontier "Direct link to Sampling from the Frontier")
...
#### Example: Pareto Table After 4 Iterations[​](#example-pareto-table-after-4-iterations "Direct link to Example: Pareto Table After 4 Iterations")
...
### Step 3: Feedback & Mutation[​](#step-3-feedback--mutation "Direct link to Step 3: Feedback & Mutation")
...
### Step 4: Acceptance[​](#step-4-acceptance "Direct link to Step 4: Acceptance")
...
### Step 5: Final Selection[​](#step-5-final-selection "Direct link to Step 5: Final Selection")
...
[Edit this page](https://github.com/confident-ai/deepeval/edit/main/docs/docs/prompt-optimization-gepa.mdx)
