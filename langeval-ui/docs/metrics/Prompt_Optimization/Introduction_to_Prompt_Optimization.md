...
Create An Optimizer[​](#create-an-optimizer "Direct link to Create An Optimizer")
---------------------------------------------------------------------------------
...
* [Optional] `async_config`: an instance of type `AsyncConfig` that allows you to [customize the degree of concurrency](/docs/something) during optimization. Defaulted to the default `AsyncConfig` values.
* [Optional] `display_config`: an instance of type `DisplayConfig` that allows you to [customize what is displayed](/docs/something) in the console during optimization. Defaulted to the default `DisplayConfig` values.
...
Optimize Your First Prompt[​](#optimize-your-first-prompt "Direct link to Optimize Your First Prompt")
------------------------------------------------------------------------------------------------------
...
Optimization Configs[​](#optimization-configs "Direct link to Optimization Configs")
------------------------------------------------------------------------------------
...
### Async Configs[​](#async-configs "Direct link to Async Configs")
...
### Display Configs[​](#display-configs "Direct link to Display Configs")
...
### Mutation Configs[​](#mutation-configs "Direct link to Mutation Configs")
...
[Edit this page](https://github.com/confident-ai/deepeval/edit/main/docs/docs/prompt-optimization-introduction.mdx)
