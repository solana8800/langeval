...
*   **[04-b-Google-OAuth-Setup.md](./04-b-Google-OAuth-Setup.md)** (Mới)
    *   Hướng dẫn từng bước tạo Google OAuth Credentials.
*   **[05-SDK-Integration.md](./05-SDK-Integration.md)**

## 4. Operations & Security
*   **[06-Deployment-DevOps.md](./06-Deployment-DevOps.md)**
*   **[06-b-Kafka-Configuration.md](./06-b-Kafka-Configuration.md)** (Mới)
    *   Cấu hình tập trung cho Kafka topics và consumer groups.
...
## 5. Hướng dẫn sử dụng
*   **[13-Dashboard-User-Guide.md](./13-Dashboard-User-Guide.md)** (Mới)
    *   Hướng dẫn chi tiết sử dụng Dashboard: Cấu hình Model, Agent, kịch bản (Scenario) và Metrics.
