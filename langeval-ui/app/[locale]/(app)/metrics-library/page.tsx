...
export default function MetricsLibraryPage() {
    ...
    const loadMetrics = async () => {
        ...
        try {
            ...
            // Map backend "definition" to frontend "description" if needed
    ...
    return (
        <div className="space-y-8 pb-8">
            {/* Header area holding title and intro */}
            <div className="flex flex-col gap-4">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 bg-white p-4 rounded-xl border shadow-sm shrink-0">
                    <div>
                        <h1 className="text-lg md:text-2xl font-bold tracking-tight text-slate-900">Metrics Library</h1>
                    ...
                    <div className="flex gap-2 md:gap-3 w-full md:w-auto">
                        ...
                        >
                            <Settings2 className="h-4 w-4" /> <span className="inline">System Settings</span>
                        </Button>
            ...
            <div className="grid gap-6">
                {/* Toolbar */}
                <div className="flex flex-col md:flex-row items-center gap-4 bg-white p-4 rounded-xl border shadow-sm shrink-0">
                    ...
                    <div className="w-full md:w-auto overflow-x-auto">
                        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                            <TabsList className="bg-slate-100/50 w-full md:w-auto justify-start">
