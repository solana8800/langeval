...
def migrate():
    ...
    try:
        ...
        with engine.connect() as conn:
            ...
            check_sql = text("SELECT column_name FROM information_schema.columns WHERE table_name='modelref' AND column_name='api_key_encrypted';")
            ...
            if result:
                ...
                alter_sql = text("ALTER TABLE modelref ADD COLUMN api_key_encrypted VARCHAR;")
